const BeansData = [
    {
        ...
        imagelink_square: require('../assests/Coffee_assests/robusta_coffee_beans/robusta_coffee_beans_square.png'),
        imagelink_portrait: require('../assests/Coffee_assests/robusta_coffee_beans/robusta_coffee_beans_portrait.png'),
        ingredients: 'Africa',
    ...
    },
    {
        ...
        roasted: 'Medium Roasted',
        imagelink_square: require('../assests/Coffee_assests/arabica_coffee_beans/arabica_coffee_beans_square.png'),
        imagelink_portrait: require('../assests/Coffee_assests/arabica_coffee_beans/arabica_coffee_beans_portrait.png'),
        ingredients: 'Africa',
        special_ingredient: 'From Africa',
        prices: [
            { size: '250gm', price: '5.60', currency: '$' },
            { size: '500gm', price: '11.50', currency: '$' },
            { size: '1Kg', price: '18.90', currency: '$' },
        ],
        average_rating: 4.9,
        ratings_count: '6,879',
        favourite: false,
    ...
    },
    {
        ...
        roasted: 'Medium Roasted',
        imagelink_square: require('../assests/Coffee_assests/liberica_coffee_beans/liberica_coffee_beans_square.png'),
        imagelink_portrait: require('../assests/Coffee_assests/liberica_coffee_beans/liberica_coffee_beans_portrait.png'),
        ingredients: 'Malaysia',
        special_ingredient: 'From Malaysia',
        prices: [
            { size: '250gm', price: '4.20', currency: '$' },
            { size: '500gm', price: '12.50', currency: '$' },
            { size: '1Kg', price: '18.80', currency: '$' },
        ],
        average_rating: 4.3,
        ratings_count: '6,879',
        favourite: false,
    ...
    },
    {
        ...
        roasted: 'Medium Roasted',
        imagelink_square: require('../assests/Coffee_assests/excelsa_coffee_beans/excelsa_coffee_beans_square.png'),
        imagelink_portrait: require('../assests/Coffee_assests/excelsa_coffee_beans/excelsa_coffee_beans_portrait.png'),
        ingredients: 'Malaysia',
        special_ingredient: 'From Malaysia',
        prices: [
            { size: '250gm', price: '6.50', currency: '$' },
            { size: '500gm', price: '9.50', currency: '$' },
            { size: '1Kg', price: '17.50', currency: '$' },
        ],
        average_rating: 4.7,
        ratings_count: '6,879',
        favourite: false,
